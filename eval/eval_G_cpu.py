...
parser.add_argument('--data_dir', default='/home/smit/val_features/val_features/', help='folder to output images and model checkpoints')
...
parser.add_argument('--model_path', default='/home/smit/saved_model/epoch_30.pth',
                    help='folder to output images and model checkpoints')
parser.add_argument('--cuda', action='store_true', help='enables cuda')
parser.add_argument('--path_to_home', type=str)

opt = parser.parse_args()
path_to_home = '/home/smit/PycharmProjects/visDial.pytorch'
